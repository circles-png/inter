...
Installation via Poetry is recommended.

## Installation and usage, via Poetry
...
### Obtaining prebuilt code

Download the artifact from the latest GitHub Actions run.

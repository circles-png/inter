...
export type ImageCropperControlsWithoutHTML = WithChildren<{ ref?: HTMLDivElement | null }>

export type ImageCropperControlsProps = ImageCropperControlsWithoutHTML
  & WithoutChildren<HTMLAttributes<HTMLDivElement>>

export type ImageCropperPreviewPropsWithoutHTML = { child?: Snippet<[{ src: string }]> }
